...
```
方案1 内存(整文件)         49 ms   1632 MB/s
方案2 流式(8KB)            41 ms   1951 MB/s
方案3 固定分块4MB+虚拟线程   9 ms   8887 MB/s
方案3 固定分块1MB+虚拟线程   9 ms   8887 MB/s
方案3 固定分块64KB+虚拟线程 17 ms   4705 MB/s
方案5 CRC32                19 ms   4210 MB/s
方案5 CRC32C               18 ms   4443 MB/s
方案6 组合SHA-256+MD5     154 ms    519 MB/s
方案6 对比: 分开算         162 ms    494 MB/s
